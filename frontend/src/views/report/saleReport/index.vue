    ...
    <a-card  :active-tab-key="currentTab" @tabChange="changeTab">
      ...
      <div style="width:100%;display: flex;justify-content: space-evenly;">
        <div style="font-size: 60px;display: flex;">
          <div style="font-size: 20px;display: flex;">販売回数<span class="total">{{totalCount}}</span></div>
        </div>
        <div style="font-size: 60px;display: flex;">
          <div style="font-size: 20px;display: flex;">販売回数数数量<span class="total">{{totalQuantity}}</span></div>
          
        </div>
        <div style="font-size: 60px;display: flex;">
          <div style="font-size: 20px;display: flex;">販売金金額<span class="total">{{totalAmount}}</span></div>
        </div>
      </div>
